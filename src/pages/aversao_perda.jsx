...
export default function AversaoPerda(props){
    ...
    return(
        ...
        <Text fontSize={enunciado_size} marginBottom={3} as='b'>uma moeda é jogada, cara você perde R$3,00. coroa você ganha R$ 6,00.</Text>
...
<Heading fontSize={questao_size}>Questão 2.</Heading>
        <Text fontSize={enunciado_size} marginBottom={3} as='b'>uma moeda é jogada, cara você perde R$4,00. coroa você ganha R$ 6,00.</Text>
...
<Heading fontSize={questao_size}>Questão 3.</Heading>
        <Text fontSize={enunciado_size} marginBottom={3} as='b'>uma moeda é jogada, cara você perde R$5,00. coroa você ganha R$ 6,00.</Text>
...
<Heading fontSize={questao_size}>Questão 4.</Heading>
        <Text fontSize={enunciado_size} marginBottom={3} as='b'>uma moeda é jogada, cara você perde R$6,00. coroa você ganha R$ 6,00.</Text>
